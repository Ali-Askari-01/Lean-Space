...
const classicPalette = ThemePalette(
  ...
  surfaceDim: Color(0xFFF5F7F2),
  surfaceBright: Color(0xFFFFFFFF),
  surfaceContainerLowest: Color(0xFFFFFFFF),
  surfaceContainerLow: Color(0xFFF9FAF4),
  ...
  onSurfaceVariant: Color(0xFF5C6E5E),
  inverseSurface: Color(0xFF1A2E1C),
  inverseOnSurface: Color(0xFFF0F2EC),
  outline: Color(0xFF9CA89E),
  outlineVariant: Color(0xFFD6DDD4),
  surfaceTint: Color(0xFF2E7D4F),
  primary: Color(0xFF2E7D4F),
  onPrimary: Color(0xFFFFFFFF),
  primaryContainer: Color(0xFFD4E8D0),
  ...
  onSecondaryContainer: Color(0xFF1A3D1E),
  tertiary: Color(0xFFB94A1F),
  onTertiary: Color(0xFFFFFFFF),
  tertiaryContainer: Color(0xFFFFDBC8),
  onTertiaryContainer: Color(0xFF5C1800),
  ...
  secondaryFixedDim: Color(0xFFA8CCA8),
  onSecondaryFixed: Color(0xFF0D2810),
  onSecondaryFixedVariant: Color(0xFF3A5E3E),
  tertiaryFixed: Color(0xFFFFDBC8),
  tertiaryFixedDim: Color(0xFFFFB598),
  onTertiaryFixed: Color(0xFF3D0C00),
  onTertiaryFixedVariant: Color(0xFF803009),
  background: Color(0xFFF9FAF4),
  onBackground: Color(0xFF1A2E1C),
  surfaceVariant: Color(0xFFEEF1EB),
  gradientHabit: [Color(0xFF43A047), Color(0xFF66BB6A)],
  gradientCta: [Color(0xFF2E7D4F), Color(0xFF43A047)],
  glassFill: Color(0xB8FFFFFF),
  glassBorder: Color(0x40FFFFFF),
  glassShadow: Color(0x142E7D4F),
  ambientGradientTop: [Color(0x302E7D4F), Colors.transparent],
  ambientGradientBottom: [Color(0x2043A047), Colors.transparent],
  dotPatternColor: Color(0x189CA89E),
  cardGradient: [Color(0xFFFFFFFF), Color(0xFFF9FAF4)],
  cardBorder: Color(0xFFE8ECE6),
  cardShadow: Color(0x0F1A2E1C),
  ...
  navIndicatorGradient: [Color(0xFF2E7D4F), Color(0xFF43A047)],
  navBackground: Color(0xF2FFFFFF),
  navBorder: Color(0xFFE8ECE6),
  heroGradient: [Color(0xFF2E7D4F), Color(0xFF1B5E3A)],
  progressTrack: Color(0xFFE8ECE6),
  progressFill: [Color(0xFF2E7D4F), Color(0xFF66BB6A)],
  bottomSheetHandle: Color(0xFFD6DDD4),
  dividerColor: Color(0xFFE8ECE6),
  fabGradient: [Color(0xFF2E7D4F), Color(0xFF43A047)],
  elevatedCardSurface: Color(0xFFFFFFFF),
  shimmerBase: Color(0x20D6DDD4),
  shimmerHighlight: Color(0x40FFFFFF),
);

// ──────────────────────────────────────────────
// Botanical Sage – muted sage, sophisticated calm
// ──────────────────────────────────────────────
const botanicalSagePalette = ThemePalette(
  surface: Color(0xFFFFFFFF),
  surfaceDim: Color(0xFFF2F4EF),
  surfaceBright: Color(0xFFFFFFFF),
  surfaceContainerLowest: Color(0xFFFFFFFF),
  ...
  onSurface: Color(0xFF1C2B1E),
  onSurfaceVariant: Color(0xFF5A6B5C),
  inverseSurface: Color(0xFF1C2B1E),
  inverseOnSurface: Color(0xFFF0F2EC),
  outline: Color(0xFF8A9A8C),
  outlineVariant: Color(0xFFCCD4C8),
  surfaceTint: Color(0xFF5B8C5E),
  primary: Color(0xFF5B8C5E),
  onPrimary: Color(0xFFFFFFFF),
  primaryContainer: Color(0xFFDCE8D8),
  onPrimaryContainer: Color(0xFF1A3D1E),
  inversePrimary: Color(0xFF8CC48E),
  secondary: Color(0xFF8B6E4A),
  onSecondary: Color(0xFFFFFFFF),
  secondaryContainer: Color(0xFFE8D8C4),
  onSecondaryContainer: Color(0xFF3A2810),
  tertiary: Color(0xFF6A7E8C),
  onTertiary: Color(0xFFFFFFFF),
  tertiaryContainer: Color(0xFFD0DCE8),
  onTertiaryContainer: Color(0xFF1A2E3A),
  error: Color(0xFFC62828),
  onError: Color(0xFFFFFFFF),
  errorContainer: Color(0xFFFFDAD6),
  onErrorContainer: Color(0xFF8C120E),
  primaryFixed: Color(0xFFB0D8B2),
  primaryFixedDim: Color(0xFF84C086),
  onPrimaryFixed: Color(0xFF0A1F0C),
  onPrimaryFixedVariant: Color(0xFF2E5E30),
  secondaryFixed: Color(0xFFE8D8C4),
  secondaryFixedDim: Color(0xFFD4C0A8),
  onSecondaryFixed: Color(0xFF2A1A08),
  onSecondaryFixedVariant: Color(0xFF6A5030),
  tertiaryFixed: Color(0xFFD0DCE8),
  tertiaryFixedDim: Color(0xFFA8C0D0),
  onTertiaryFixed: Color(0xFF0E1E28),
  onTertiaryFixedVariant: Color(0xFF3A5A6E),
  background: Color(0xFFF7F8F4),
  onBackground: Color(0xFF1C2B1E),
  surfaceVariant: Color(0xFFECF0E8),
  gradientHabit: [Color(0xFF5B8C5E), Color(0xFF8CC48E)],
  gradientCta: [Color(0xFF5B8C5E), Color(0xFF78A87A)],
  glassFill: Color(0xB8FFFFFF),
  glassBorder: Color(0x40FFFFFF),
  glassShadow: Color(0x145B8C5E),
  ambientGradientTop: [Color(0x305B8C5E), Colors.transparent],
  ambientGradientBottom: [Color(0x208CC48E), Colors.transparent],
  dotPatternColor: Color(0x188A9A8C),
  cardGradient: [Color(0xFFFFFFFF), Color(0xFFF7F8F4)],
  cardBorder: Color(0xFFE0E4DA),
  cardShadow: Color(0x0F1C2B1E),
  shareCardGradient: [Color(0xFF1A2E1C), Color(0xFF2E4A30), Color(0xFF5B8C5E)],
  shareCardBokeh: [Color(0xFFB0D8B2), Color(0xFFE8D8C4), Color(0xFFD0DCE8)],
  shareCardAccent: Color(0xFF8CC48E),
  navIndicatorGradient: [Color(0xFF5B8C5E), Color(0xFF8CC48E)],
  navBackground: Color(0xF2FFFFFF),
  navBorder: Color(0xFFE0E4DA),
  heroGradient: [Color(0xFF5B8C5E), Color(0xFF3E6E40)],
  progressTrack: Color(0xFFE0E4DA),
  progressFill: [Color(0xFF5B8C5E), Color(0xFF8CC48E)],
  bottomSheetHandle: Color(0xFFCCD4C8),
  dividerColor: Color(0xFFE0E4DA),
  fabGradient: [Color(0xFF5B8C5E), Color(0xFF78A87A)],
  elevatedCardSurface: Color(0xFFFFFFFF),
  shimmerBase: Color(0x20CCD4C8),
  shimmerHighlight: Color(0x40FFFFFF),
);
...
abstract final class AppColors {
  ...
  static ThemePalette get palette {
    switch (currentPreset) {
      ...
      case ThemePreset.botanicalSage: return botanicalSagePalette;
